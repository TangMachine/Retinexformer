...
parser.add_argument('--input_images_path', default='./test_images')#原始图像路径
parser.add_argument('--image2smiles2image_save_path', default='./results')#增强图像路径
...
if __name__ == '__main__':
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        ssim_val_rgb.append(ssim_loss(rgb_restored, rgb_groundtruth, channel_axis=2,data_range = 255))
